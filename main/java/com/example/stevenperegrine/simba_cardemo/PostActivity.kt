...
class PostActivity : AppCompatActivity() {
    ...
    public fun post(view: View) {
        ...
        if (postMake.text.isNotEmpty() && postModel.text.isNotEmpty() && postVIN.text.isNotEmpty()) {
            ...
            val builder = Retrofit.Builder()
                .baseUrl("https://api.simbachain.com/v1/BC4ConCarDemo1/")
           ...
           else
            {
                ...
                PostService().postWithImage(this,postMake.text.toString(),postModel.text.toString(),postVIN.text.toString(),userAddress,File(mCurrentPhotoPath), object : Callback<Models.PostCar>{
                    override fun onResponse(call: Call<Models.PostCar>, response: Response<Models.PostCar>) {
                    ...
                    override fun onFailure(call: Call<Models.PostCar>, t: Throwable) {
                        ...
                        Toast.makeText(this@PostActivity, "Error is: " + t.toString(), Toast.LENGTH_LONG).show()
                    }
    ...
    fun signtransaction(response: Response<Models.PostCar>){
        ...
        val httpClient = OkHttpClient.Builder().build()
        val builder = Retrofit.Builder()
            .baseUrl("https://api.simbachain.com/v1/BC4ConCarDemo1/transaction/"+postid+ "/")
            .addConverterFactory(GsonConverterFactory.create())
