...
class GetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call.enqueue(object : Callback<Models.GetCars> {
            ...
            override fun onFailure(call: Call<Models.GetCars>, t: Throwable) {
                Toast.makeText(this@GetActivity, "Error is: " + t.toString(), Toast.LENGTH_LONG).show()
    ...
    fun filteredGet(view: View){
        ...
        val builder = Retrofit.Builder()
            .baseUrl("https://api.simbachain.com/v1/BC4ConCarDemo1/registerCar/?Make_contains=" + filterText.text.toString())
            .addConverterFactory(GsonConverterFactory.create())
